...
if ($result->num_rows > 0) {
    ...
    .container {
        ...
        box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1); /* Ombre autour du conteneur */
    ...
    tr:nth-child(even) {
        background-color: #e7f9e7; /* Vert clair pour les lignes paires */
    }
    
    tr:hover {
        background-color: #c8e6c9; /* Couleur au survol */
    }
