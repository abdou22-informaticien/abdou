...
if (isset($_POST['code_module']) && isset($_POST['designation']) && isset($_POST['coefficient']) && isset($_POST['volume_horaire']) && isset($_POST['filiere'])) {
    ...
    $sql = "INSERT INTO Module (CodeModule, DesignationModule, Coefficient, VolumeHoraire, Filiere) VALUES ('$code_module', '$designation', $coefficient, $volume_horaire, '$filiere')";
