...
<form action="enregistrerENS.php" method="post">
    ...
    <input type="submit" name="mo" value="Statistique_user" formaction="Statuse.php" />
    <br><br>
    ...
    <input type="submit" value="Affichage JavaScript" onclick="affichageJavascript()" />
    <input type="submit" value="Enregistrer" name="enregistrer" />
    <input type="submit" value="Affichage Liste" formaction="affENS.php" />
    <input type="file" id="imageFile" accept="image/*" style="display: none" />
    <input type="submit" value="Supprimer" formaction="suppENS.php" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet étudiant?')" />
