...
if (isset($_POST['numero']) && isset($_POST['civilite']) && isset($_POST['pays']) && isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['adresse']) && isset($_POST['postal1']) && isset($_POST['postal2']) && isset($_POST['plateform']) && isset($_POST['application']) && isset($_POST['nationalite']) && isset($_POST['filiere']) && isset($_POST['loisir'])) {
